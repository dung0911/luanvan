...
const routes = [
    ...
    },
    {
        path: "/vechungtoi",
        name: "vechungtoi",
        component: () => import("../views/User/Infomation/VeChungToi.vue"),
    },
    {
        path: "/dieukhoansudung",
        name: "dieukhoansudung",
        component: () => import("../views/User/Infomation/DieuKhoanSuDung.vue"),
    },
    {
        path: "/thongtingiaohang",
        name: "thongtingiaohang",
        component: () =>
            import("../views/User/Infomation/ThongTinGiaoHang.vue"),
    },
];
